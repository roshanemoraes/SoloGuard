...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    full: "Full",
    lowPower: "Low Power",
    sosSent: "Message Ready",
    sosIssue: "SOS Issue",
    sosSentMessage: "Message opened. Please tap Send in your messaging app.",
    sosFailedMessage: "Failed to open messaging app. Check settings.",
    ...
    logsHint: "Monitoring logs will appear here once you start using SoloGuard",
  ...
  si: {
    ...
    sosSent: "පණිවුඩය සූදානම්",
    sosIssue: "SOS ගැටලුවක්",
    sosSentMessage: "පණිවුඩය විවෘතයි. කරුණාකර ඔබගේ පණිවුඩ යෙදුමෙන් යවන්න තට්ටු කරන්න.",
    sosFailedMessage: "පණිවුඩ යෙදුම විවෘත කිරීම අසාර්ථකයි. සැකසුම් පරීක්ෂා කරන්න.",
    ...
    logsHint: "SoloGuard භාවිතා කිරීම ඇරඹූ විට ලොග් මෙහි දිස්වේ.",
